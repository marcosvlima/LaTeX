...
\input{./dados/quadros/colunas}

Por fim, existem alguns símbolos que precisamos utilizar para delimitar e formatar as informações contidas dentro das tabelas, conforme o Quadro mostra.
